/*
 * BOM dashboard: the view you see when you click the "BOM Data" folder.
 * Copied from ../xplane/dashboardView.js (same grid, plots and readout
 * columns) with the BOM's measurements. Change LAYOUT below to rearrange it.
 *
 *   ┌──────── Pressure Altitude ───────┬────────── Indicated Airspeed ──────────┐
 *   ├──── Pitch ─────┬───── Roll ──────┼─ Alt ─┬─ IAS ─┬─ Pitch ─┬─ Roll ──────┤  <- readout columns
 *   └────────────────┴─────────────────┴───────┴───────┴─────────┴─────────────┘
 *   (scroll down)  Heading | Vertical Speed | Ground Speed | G Load |
 *                  GPS Altitude | Slip/Skid | Latitude | Longitude
 *
...
const DECIMALS = { pressure_altitude: 0, airspeed: 1, pitch: 1, roll: 1, latitude: 5, longitude: 5 };
